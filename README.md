...
推送到 `main` 后，GitHub Actions 会自动构建 Windows x64 的 MSI、NSIS 安装包和 `dailyflow.exe`。构建产物可从[工作流运行记录](https://github.com/Skydoge-zjm/DailyFlow/actions/workflows/windows-build.yml)下载。
